...
// const arrawFun = () => {
//   console.log("这里index页面测试Es6的箭头函数");
// }
...
class List {
  constructor() {
    ...
    let listLiDom = listDom.getElementsByClassName('line');

    for (let index = 0; index < listLiDom.length; index++) {
      const element = listLiDom[index];
